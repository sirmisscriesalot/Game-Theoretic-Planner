...
x_1_3 = third_powers[1][0]
x_1_2 = second_powers[1][0]
x_1_1 = first_powers[1][0]
x_1_0 = no_powers[1][0]

y_1_3 = third_powers[1][1]
y_1_2 = second_powers[1][1]
y_1_1 = first_powers[1][1]
y_1_0 = no_powers[1][1]
...
ans = find_closest_point(np.array([2, 2, x_1_0, x_1_1, x_1_2, x_1_3, y_1_0, y_1_1, y_1_2, y_1_3]))
print(ans)
x = cs(1+ans)[0][0][0]
y = cs(1+ans)[0][0][1]
...
plt.plot([x], [y], 'ro')
plt.plot([2],[2], 'ro')
plt.plot(np.linspace(x,2), np.linspace(y,2), 'g--')
